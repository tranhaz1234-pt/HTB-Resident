...
/**
 * Title: Archive
 * Slug: coworking-office/archive
 */
?>
<!-- wp:pattern {"slug":"coworking-office/archive-title"} /-->
...
<div class="wp-block-column" style="flex-basis:70%"><!-- wp:term-description {"align":"wide","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|xx-large"}}},"textColor":"body","fontSize":"x-large"} /-->
